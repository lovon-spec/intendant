...
*v0.5.21 draft, 2026-07-16. Supersedes v0.1–v0.5.20
...
v0.5.18; v0.5.19 and v0.5.20 in the program's `archive/`).
...
D-201..D-204 (§15 — an affirmative decision record; nothing
...
carrier to shared evidence-arrival structure). Gate document under the frozen umbrella RFC
...
- **T5 (lease binding, non-backdateable).** An operation under an
  ...
  owner-visible residual of alternative (ii). Held timely evidence
