...
*v0.5.22 draft, 2026-07-16. Supersedes v0.1–v0.5.21
...
v0.5.18; v0.5.19 through v0.5.21 in the program's `archive/`).
...
D-201..D-205 (§15 — an affirmative decision record; nothing
...
registration). Gate document under the frozen umbrella RFC
